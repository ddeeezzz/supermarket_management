/********************************************************************************
** Form generated from reading UI file 'mainwindow_userstab.ui'
**
...
#ifndef UI_MAINWINDOW_USERSTAB_H
#define UI_MAINWINDOW_USERSTAB_H
...
public:
    ...
    void setupUi(QMainWindow *MainWindow_UsersTab)
    {
        if (MainWindow_UsersTab->objectName().isEmpty())
            MainWindow_UsersTab->setObjectName("MainWindow_UsersTab");
        MainWindow_UsersTab->resize(679, 471);
        centralwidget = new QWidget(MainWindow_UsersTab);
...
"background-color: rgb(205, 216, 239);"));
        ...
        MainWindow_UsersTab->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow_UsersTab);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 679, 17));
        MainWindow_UsersTab->setMenuBar(menubar);
        statusbar = new QStatusBar(MainWindow_UsersTab);
        statusbar->setObjectName("statusbar");
        MainWindow_UsersTab->setStatusBar(statusbar);

        retranslateUi(MainWindow_UsersTab);

        stackedWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(MainWindow_UsersTab);
    } // setupUi

    void retranslateUi(QMainWindow *MainWindow_UsersTab)
    {
        MainWindow_UsersTab->setWindowTitle(QCoreApplication::translate("MainWindow_UsersTab", "\347\224\250\346\210\267\347\256\241\347\220\206", nullptr));
        bin_add->setText(QCoreApplication::translate("MainWindow_UsersTab", "\345\242\236\345\212\240", nullptr));
        bin_update->setText(QCoreApplication::translate("MainWindow_UsersTab", "\344\277\256\346\224\271", nullptr));
        bin_delete->setText(QCoreApplication::translate("MainWindow_UsersTab", "\345\210\240\351\231\244", nullptr));
#if QT_CONFIG(tooltip)
        le_search->setToolTip(QCoreApplication::translate("MainWindow_UsersTab", "\345\217\257\346\237\245\350\257\242\345\220\215\347\247\260", nullptr));
#endif // QT_CONFIG(tooltip)
        le_search->setText(QString());
        bin_search->setText(QCoreApplication::translate("MainWindow_UsersTab", "\346\220\234\347\264\242", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("MainWindow_UsersTab", "\346\226\260\345\273\272\345\210\227", nullptr));
        bin_clear->setText(QCoreApplication::translate("MainWindow_UsersTab", "\346\270\205\347\251\272", nullptr));
        lb_cnt->setText(QCoreApplication::translate("MainWindow_UsersTab", "\350\256\242\345\215\225\346\225\260\351\207\217\357\274\232", nullptr));
    } // retranslateUi

};

namespace Ui {
    class MainWindow_UsersTab: public Ui_MainWindow_UsersTab {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MAINWINDOW_USERSTAB_H
